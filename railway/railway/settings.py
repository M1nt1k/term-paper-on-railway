...
SECRET_KEY = 'django-insecure-ox6!tt2v!tm=z7__k1w5z%&$&!j-x3*_^2+zvg6sops_2zurlp'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'railway/templates'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
CACHES = {
    'default': {
        ...
        'LOCATION': os.path.join(BASE_DIR, 'railways_cache'),
    }
}
